...
- **PostService** (controller/coordinator) — business rules for posts:
duplicate checks, ownership, draft/published transitions.
...
Modules pass simple data objects to each other; none depends on 
another's internal implementation details.